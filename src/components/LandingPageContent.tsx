          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            <Card className="text-center border-2 hover:border-primary/50 transition-colors">
              <CardContent className="pt-6">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2">1. Capture & Upload</h3>
            ...
            <Card className="text-center border-2 hover:border-primary/50 transition-colors">
              <CardContent className="pt-6">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2">2. De-identify</h3>
                <p className="text-sm sm:text-base text-muted-foreground">
            ...
            <Card className="text-center border-2 hover:border-primary/50 transition-colors">
              <CardContent className="pt-6">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2">3. AI Analysis</h3>
                <p className="text-sm sm:text-base text-muted-foreground">
